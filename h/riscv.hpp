...
{
public:
    Riscv(const Riscv &obj) = delete;

    void operator=(const Riscv &) = delete;

    // pop sstatus.spp and sstatus.spie bits (has to be a non inline function)
    static void popSppSpie();

    //=======Console=============
    static IOBuffer* inputBuffer;

    static IOBuffer* outputBuffer;

    static sem_t inputSem;

    static sem_t outputSem;

    // init InputBuffer , outputBuffer, InputSem, ouputSem
